...
namespace Fara.FaraVRMMultiConverter.Editor
{
    ...
    public static class L10N
    {
        ...
        public static class Converter
        {
            ...
            public static string SourceVrcPrefab =>
                LocalizationManager.Get("VRC → VRMに変換するアバター", "VRC → VRM Conversion avatar");

            public static string IsVrmComponentCopy => LocalizationManager.Get("他のアバターからVRM Componentをコピー",
            ...
            public static string ThumbnailAlreadyExists => LocalizationManager.Get("サムネイルは作成済みなので既存のサムネイルを適用します",
                "The thumbnail has already been created, so apply the existing thumbnail");
            ...
            public static string AvatarElement(int index) =>
                LocalizationManager.Get($"変換アバター{index + 1}体目", $"Avatar {index + 1}");
        ...
        public static class DeleteObjectsEditor
        {
            ...
            public static string SelectFromHierarchy =>
                LocalizationManager.Get("Hierarchyから選択", "Select from Hierarchy");
